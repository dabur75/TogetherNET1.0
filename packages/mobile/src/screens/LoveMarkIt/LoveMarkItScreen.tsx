...
export default function LoveMarkItScreen() {
  const { language } = useLanguage()
  const rtlStyles = useRTLStyles()

  const title = language === 'he' ? 'Love-Mark-It' : 'Love-Mark-It'
  const subtitle =
    language === 'he'
      ? 'עכשיו סמן את האהבה שלך לפעולה עבור אחרים'
      : 'Now mark your love into action for others'

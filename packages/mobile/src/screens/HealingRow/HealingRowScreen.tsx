...
export default function HealingRowScreen() {
  const { language } = useLanguage()
  const rtlStyles = useRTLStyles()

  const title = language === 'he' ? 'HealingRow' : 'HealingRow'
  const subtitle =
    language === 'he'
      ? 'בואו לגדול דרך זה יחד באופן שיטתי'
      : "Let's grow through this systematically together"
